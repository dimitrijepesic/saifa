...
Ovaj dokument je izvor istine o tome **šta sve platforma radi**: svaki scenario je jedna moguća funkcionalnost, sa akterom, tokom i ishodom. Iz njega se vidi i **šta se može pokriti gotovim alatom** (vidi `SAIFA_gotove_komponente_po_slojevima.md` za „gotovo vs custom" po sloju i `popis_final.md` za sve razmatrane opcije). Faza isporuke i MVP se ne određuju ovde nego u `mvp_kriterijumi.md`, a otvorena pitanja u `otvorene_odluke.md`.
...
| AIF-UC | AI factory poslovi (pokretanje, status, rezultati, zaustavljanje, paralelni) | 4, 13 |
| MOD-UC | Model lifecycle i registry (trening, eval, verzije, objava, verifikacija) | 5, 13 |
| EDU-UC | Edukacija, kursevi, lab vežbe | 8 |
| OBS-UC | Monitoring, alarmi, audit, istorija, statistike i status platforme | 9, 12 |
| USG-UC | Praćenje potrošnje resursa i usage dashboard | 9, 12 |
| FED-UC | Federacija sa Pharos/IT4LIA i onboarding partnera | 10 |
| CNT-UC | Kontejneri (build/registracija, korišćenje u poslu) | 11 |
| SUP-UC | Ticketing i korisnička podrška | 12 |
| WF-UC | Pipeline i workflow orkestracija | 4 |
...
| 4. AI factory i pokretanje poslova | AIF-UC-001…007, ORG-UC-006, WF-UC-001 |
| 5. Model lifecycle | MOD-UC-001…013 |
| 6. Upravljanje datasetovima | CAT-UC-006…010 |
| 7. Kolaboracija i timski rad | ORG-UC-007…009, ORG-UC-011 |
...
| 10. Federacija (Pharos, IT4LIA) | FED-UC-001…005 |
| 11. Kontejneri | CNT-UC-001, CNT-UC-002 |
| 12. Statistike i dashboard | USG-UC-002, OBS-UC-005, OBS-UC-006, SUP-UC-001 |
| 13. Paralelno pokretanje i verifikacija | AIF-UC-008, MOD-UC-014 |
